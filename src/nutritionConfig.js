// Nutrition food-search config.
//
// 1. Go to https://fdc.nal.usda.gov/api-key-signup.html
// 2. Enter your email — USDA emails you a free API key instantly, no cost, no card.
// 3. Paste that key below, replacing YOUR_USDA_API_KEY.
//
